...
import 'package:fitness_app/layers/presentation_layer/add_routine/bloc/routine_add_event.dart';
import 'package:fitness_app/layers/presentation_layer/add_routine/bloc/routine_add_state.dart';
...
class RoutineAddBloc extends Bloc<RoutineAddEvent, RoutineAddState> {
  ...
  RoutineAddBloc({required this.addRoutine, required this.updateRoutine, required this.getRoutine}) : super(RoutineAddInitialState()) {
