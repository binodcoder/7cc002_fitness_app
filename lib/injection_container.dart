...
Future<void> init() async {
  ...
  sl.registerLazySingleton<AddUserLocalDataSources>(() => AddUserLocalDataSourcesImpl());
  sl.registerLazySingleton<AddUserRemoteDataSource>(()=>AddUserRemoteDataSourceImpl(client: sl()));
